...
const Footer = () => {
  return (
    <div className="footer-2 bg-gray-800 pt-6 md:pt-12 mt-4">
      <div className="container px-4 mx-auto">
        <div className="md:flex md:flex-wrap md:-mx-4 py-6 md:pb-12">
          <div className="footer-info lg:w-1/3 md:px-4">
            <h4 className="text-white text-2xl mb-4">
              Users are using meo mèo méo mèo meo blocks and making their life
              easy.
            </h4>
            ...
            <div className="mt-4">
              ...
              <button className="bg-twitter py-2 px-4 text-white rounded ml-2 mt-2 transition-colors duration-300">
                <span className="fab fa-twitter mr-2" /> Follow @meomeo
              </button>
            </div>
          </div>
          ...
          <div className="md:flex md:-mx-4 md:items-center">
            <div className="md:flex-1 md:px-4 text-center md:text-left">
              <p className="text-white">
                © <strong>Meo mèo méo mèo meo</strong>
              </p>
            </div>
